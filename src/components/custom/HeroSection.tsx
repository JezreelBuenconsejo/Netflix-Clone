  ...
  return (
    <div className="relative">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 md:px-8 lg:px-16">
        <div className="max-w-4xl mx-auto text-center my-14 pt-10 sm:my-0 sm:pt-0 sm:mb-0">
          {/* Main Heading */}
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
            ...
            <Button className="bg-[#e50914] hover:bg-[#f40612] has-[>svg]:px-8 py-3 text-2xl rounded h-[62px]">
              <Link
                ...
                className="h-full text-white font-semibold flex items-center justify-center gap-3"
              >
